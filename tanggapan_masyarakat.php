...
<body>
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                <h3 style="color:white"> WEB PENGADUAN PKL<br>
                                    KOTA SURAKARTA</h3>
                                <p style="color:white">Selamat datang di web Pengaduan PKL Kota Surakarta<br>
                                    Silahkan adukan Keluh Kesah anda terhadap keberadaan PKL Kota Surakarta</p>
    ...
    <p class="tulisan_input2">TANGGAPAN ADUAN MASYARAKAT</p>
<form method="post">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">KOTA</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
